...
<body>
    <header>
        <nav>
            <ul class="menu">
                <li><a href="/Abdelkader-ouahbrache-app-jo2028/pages/admin/admin.php">Accueil Administration</a></li>
                <li><a href="/Abdelkader-ouahbrache-app-jo2028/pages/admin/admin-sports/manage-sports.php">Gestion Sports</a></li>
                <li><a href="/Abdelkader-ouahbrache-app-jo2028/pages/admin/admin-places/manage-places.php">Gestion Lieux</a></li>
                <li><a href="/Abdelkader-ouahbrache-app-jo2028/pages/admin/admin-countries/manage-countries.php">Gestion Pays</a></li>
                <li><a href="/Abdelkader-ouahbrache-app-jo2028/pages/admin/admin-events/manage-events.php">Gestion Calendrier</a></li>
                <li><a href="/Abdelkader-ouahbrache-app-jo2028/pages/admin/admin-athletes/manage-athletes.php">Gestion Athlètes</a></li>
                <li><a href="/Abdelkader-ouahbrache-app-jo2028/pages/admin/admin-results/manage-results.php">Gestion Résultats</a></li>
    ...
    <main>
        ...
        try {
            ...
            $query = "SELECT id_pays, nom_pays, code_pays FROM pays ORDER BY nom_pays";
            $statement = $connexion->prepare($query);
            $statement->execute();

            // Vérifier s'il y a des résultats
            if ($statement->rowCount() > 0) {
                // Ajout de la colonne Code pour plus d'information si elle existe
                echo "<table><tr><th>Pays</th><th>Code Pays (CIO)</th><th>Modifier</th><th>Supprimer</th></tr>"; 

                // Afficher les données dans un tableau
                while ($row = $statement->fetch(PDO::FETCH_ASSOC)) {
                    echo "<tr>";
                    echo "<td>" . htmlspecialchars($row['nom_pays'], ENT_QUOTES, 'UTF-8') . "</td>";
                    echo "<td>" . htmlspecialchars($row['code_pays'], ENT_QUOTES, 'UTF-8') . "</td>";
